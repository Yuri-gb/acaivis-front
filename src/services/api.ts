...
export const api = {
    ...
    createMercadoPagoPayment: (orderId:number, payload: { paymentMethodId:string; paymentMethodType:string; token:string|null; installments:number|null; payerEmail:string; payerIdentificationType?:string; payerIdentificationNumber?:string; idempotencyKey?:string }) => request<import('../types/api').MercadoPagoPaymentResponse>(`/payments/orders/${orderId}`, { method:'POST', body:JSON.stringify(payload) }),
