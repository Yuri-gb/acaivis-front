...
export interface TrackingOrder { trackingCode: string; status: OrderStatus; createdAt: string; subtotal: number; deliveryFee: number; total: number; deliveryZoneName: string; address: string; items: OrderItem[] }
