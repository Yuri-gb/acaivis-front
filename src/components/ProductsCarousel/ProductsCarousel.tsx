...
function ProductsCarousel({
    ...
    const handleAddToCart = (productId: number) => {
        ...
        if (!product) return
        addToCart({ productId: product.id, image: product.image, name: product.name, description: product.description, unitPrice: Number(product.price.replace('R$','').replace('.','').replace(',','.').trim()), quantity: 1 })
    }
